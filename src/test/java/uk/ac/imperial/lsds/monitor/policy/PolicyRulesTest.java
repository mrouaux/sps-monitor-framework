...
import uk.ac.imperial.lsds.monitor.policy.operator.OneOperator;
import static uk.ac.imperial.lsds.monitor.policy.operator.Operator.*;
import uk.ac.imperial.lsds.monitor.policy.scale.constraint.AbsoluteScaleConstraint;
import static uk.ac.imperial.lsds.monitor.policy.scale.constraint.ScaleConstraint.*;
import uk.ac.imperial.lsds.monitor.policy.scale.factor.RelativeScaleFactor;
